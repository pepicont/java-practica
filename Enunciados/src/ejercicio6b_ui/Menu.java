package ejercicio6b_ui;

import java.util.Date;
import java.util.Scanner;

import ejercicio6b_entidades.Product;
import ejercicio6b_logica.ProductLogic;
	...
	private void executeCommand(String command) {
		...
		case "update":
			System.out.println("");
			 ...
			 System.out.print("¿El artículo está deshabilitado? (true/false): ");
			 Date disabledOn = Boolean.parseBoolean(s.nextLine()) ? new Date() : null; //si el artículo está deshabilitado, seteo la fecha actual, sino null.
			 try {
				 System.out.println("Producto actualizado: " + pl.update(idUpdate, nameUpdate, descriptionUpdate, priceUpdate, stockUpdate, shippingIncludedUpdate, disabledOn));
			 } catch (Exception e) {
